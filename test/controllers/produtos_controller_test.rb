...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { descricao: @produto.descricao, dt_entrada: @produto.dt_entrada, dt_validade: @produto.dt_validade, estoque: @produto.estoque, medida: @produto.medida, nome: @produto.nome } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao: @produto.descricao, dt_entrada: @produto.dt_entrada, dt_validade: @produto.dt_validade, estoque: @produto.estoque, medida: @produto.medida, nome: @produto.nome } }
